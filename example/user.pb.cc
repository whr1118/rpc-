...
class RegisterReuqestDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<RegisterReuqest> _instance;
...
static void InitDefaultsscc_info_RegisterReuqest_user_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_RegisterReuqest_default_instance_;
    new (ptr) ::fixbug::RegisterReuqest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::RegisterReuqest::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_RegisterReuqest_user_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_RegisterReuqest_user_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::RegisterReuqest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::RegisterReuqest, id_),
  PROTOBUF_FIELD_OFFSET(::fixbug::RegisterReuqest, name_),
  PROTOBUF_FIELD_OFFSET(::fixbug::RegisterReuqest, pwd_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 21, -1, sizeof(::fixbug::RegisterReuqest)},
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_RegisterReuqest_default_instance_),
...
const char descriptor_table_protodef_user_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ixbug.RegisterReuqest\032\030.fixbug.RegisterR"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_user_2eproto_sccs[5] = {
  ...
  &scc_info_RegisterReuqest_user_2eproto.base,
  &scc_info_ResultCode_user_2eproto.base,
};
...
void RegisterReuqest::InitAsDefaultInstance() {
}
class RegisterReuqest::_Internal {
 public:
};

RegisterReuqest::RegisterReuqest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:fixbug.RegisterReuqest)
}
RegisterReuqest::RegisterReuqest(const RegisterReuqest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_name().empty()) {
  ...
  id_ = from.id_;
  // @@protoc_insertion_point(copy_constructor:fixbug.RegisterReuqest)
}

void RegisterReuqest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_RegisterReuqest_user_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  pwd_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  id_ = 0u;
}

RegisterReuqest::~RegisterReuqest() {
  // @@protoc_insertion_point(destructor:fixbug.RegisterReuqest)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void RegisterReuqest::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  name_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  pwd_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void RegisterReuqest::ArenaDtor(void* object) {
  RegisterReuqest* _this = reinterpret_cast< RegisterReuqest* >(object);
  (void)_this;
}
void RegisterReuqest::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void RegisterReuqest::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const RegisterReuqest& RegisterReuqest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_RegisterReuqest_user_2eproto.base);
  return *internal_default_instance();
}


void RegisterReuqest::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.RegisterReuqest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* RegisterReuqest::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
...
::PROTOBUF_NAMESPACE_ID::uint8* RegisterReuqest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.RegisterReuqest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.RegisterReuqest)
  return target;
}

size_t RegisterReuqest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.RegisterReuqest)
  size_t total_size = 0;
...
void RegisterReuqest::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.RegisterReuqest)
  GOOGLE_DCHECK_NE(&from, this);
  const RegisterReuqest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RegisterReuqest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.RegisterReuqest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.RegisterReuqest)
    MergeFrom(*source);
  }
}

void RegisterReuqest::MergeFrom(const RegisterReuqest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.RegisterReuqest)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void RegisterReuqest::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.RegisterReuqest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void RegisterReuqest::CopyFrom(const RegisterReuqest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.RegisterReuqest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool RegisterReuqest::IsInitialized() const {
  return true;
}

void RegisterReuqest::InternalSwap(RegisterReuqest* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  name_.Swap(&other->name_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  pwd_.Swap(&other->pwd_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
::PROTOBUF_NAMESPACE_ID::Metadata RegisterReuqest::GetMetadata() const {
  return GetMetadataStatic();
}
...
void UserServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
  ...
  switch(method->index()) {
    ...
    case 1:
      Register(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::RegisterReuqest*>(
                 request),
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetRequestPrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::RegisterReuqest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
template<> PROTOBUF_NOINLINE ::fixbug::RegisterReuqest* Arena::CreateMaybeMessage< ::fixbug::RegisterReuqest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::RegisterReuqest >(arena);
}
