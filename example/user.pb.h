...
class RegisterReuqestDefaultTypeInternal;
extern RegisterReuqestDefaultTypeInternal _RegisterReuqest_default_instance_;
class ResultCode;
...
template<> ::fixbug::RegisterReuqest* Arena::CreateMaybeMessage<::fixbug::RegisterReuqest>(Arena*);
...
class RegisterReuqest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.RegisterReuqest) */ {
 public:
  inline RegisterReuqest() : RegisterReuqest(nullptr) {};
  virtual ~RegisterReuqest();

  RegisterReuqest(const RegisterReuqest& from);
  RegisterReuqest(RegisterReuqest&& from) noexcept
    : RegisterReuqest() {
    *this = ::std::move(from);
  }

  inline RegisterReuqest& operator=(const RegisterReuqest& from) {
    CopyFrom(from);
    return *this;
  }
  inline RegisterReuqest& operator=(RegisterReuqest&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const RegisterReuqest& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const RegisterReuqest* internal_default_instance() {
    return reinterpret_cast<const RegisterReuqest*>(
               &_RegisterReuqest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(RegisterReuqest& a, RegisterReuqest& b) {
    a.Swap(&b);
  }
  inline void Swap(RegisterReuqest* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(RegisterReuqest* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline RegisterReuqest* New() const final {
    return CreateMaybeMessage<RegisterReuqest>(nullptr);
  }

  RegisterReuqest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<RegisterReuqest>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const RegisterReuqest& from);
  void MergeFrom(const RegisterReuqest& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(RegisterReuqest* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.RegisterReuqest";
  }
  protected:
  explicit RegisterReuqest(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.RegisterReuqest)
 private:
  class _Internal;
...
// uint32 id = 1;
inline void RegisterReuqest::clear_id() {
  id_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RegisterReuqest::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RegisterReuqest::id() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterReuqest.id)
  return _internal_id();
}
inline void RegisterReuqest::_internal_set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  id_ = value;
}
inline void RegisterReuqest::set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterReuqest.id)
}

// bytes name = 2;
inline void RegisterReuqest::clear_name() {
  name_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& RegisterReuqest::name() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterReuqest.name)
  return _internal_name();
}
inline void RegisterReuqest::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterReuqest.name)
}
inline std::string* RegisterReuqest::mutable_name() {
  // @@protoc_insertion_point(field_mutable:fixbug.RegisterReuqest.name)
  return _internal_mutable_name();
}
inline const std::string& RegisterReuqest::_internal_name() const {
  return name_.Get();
}
inline void RegisterReuqest::_internal_set_name(const std::string& value) {
  
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void RegisterReuqest::set_name(std::string&& value) {
  
  name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RegisterReuqest.name)
}
inline void RegisterReuqest::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:fixbug.RegisterReuqest.name)
}
inline void RegisterReuqest::set_name(const void* value,
    size_t size) {
  
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:fixbug.RegisterReuqest.name)
}
inline std::string* RegisterReuqest::_internal_mutable_name() {
  
  return name_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* RegisterReuqest::release_name() {
  // @@protoc_insertion_point(field_release:fixbug.RegisterReuqest.name)
  return name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void RegisterReuqest::set_allocated_name(std::string* name) {
  if (name != nullptr) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegisterReuqest.name)
}
inline std::string* RegisterReuqest::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:fixbug.RegisterReuqest.name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RegisterReuqest::unsafe_arena_set_allocated_name(
    std::string* name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (name != nullptr) {
  ...
  name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.RegisterReuqest.name)
}

// bytes pwd = 3;
inline void RegisterReuqest::clear_pwd() {
  pwd_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& RegisterReuqest::pwd() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterReuqest.pwd)
  return _internal_pwd();
}
inline void RegisterReuqest::set_pwd(const std::string& value) {
  _internal_set_pwd(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterReuqest.pwd)
}
inline std::string* RegisterReuqest::mutable_pwd() {
  // @@protoc_insertion_point(field_mutable:fixbug.RegisterReuqest.pwd)
  return _internal_mutable_pwd();
}
inline const std::string& RegisterReuqest::_internal_pwd() const {
  return pwd_.Get();
}
inline void RegisterReuqest::_internal_set_pwd(const std::string& value) {
  
  pwd_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void RegisterReuqest::set_pwd(std::string&& value) {
  
  pwd_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RegisterReuqest.pwd)
}
inline void RegisterReuqest::set_pwd(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pwd_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:fixbug.RegisterReuqest.pwd)
}
inline void RegisterReuqest::set_pwd(const void* value,
    size_t size) {
  
  pwd_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:fixbug.RegisterReuqest.pwd)
}
inline std::string* RegisterReuqest::_internal_mutable_pwd() {
  
  return pwd_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* RegisterReuqest::release_pwd() {
  // @@protoc_insertion_point(field_release:fixbug.RegisterReuqest.pwd)
  return pwd_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void RegisterReuqest::set_allocated_pwd(std::string* pwd) {
  if (pwd != nullptr) {
  ...
  pwd_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), pwd,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegisterReuqest.pwd)
}
inline std::string* RegisterReuqest::unsafe_arena_release_pwd() {
  // @@protoc_insertion_point(field_unsafe_arena_release:fixbug.RegisterReuqest.pwd)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return pwd_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RegisterReuqest::unsafe_arena_set_allocated_pwd(
    std::string* pwd) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (pwd != nullptr) {
  ...
  pwd_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      pwd, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.RegisterReuqest.pwd)
}
